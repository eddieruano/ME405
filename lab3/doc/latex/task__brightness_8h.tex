...
\begin{DoxyCompactList}\small\item\em This task controls the brightness of an L\-E\-D based on input from an A/\-D converter that also drives 2 motors. \end{DoxyCompactList}\end{DoxyCompactItemize}
